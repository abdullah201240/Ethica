  ...
  const columns: ColumnDef<PlatformUser>[] = [
    {
      ...
      cell: ({ row }) => (
        <Link
          ...
          className="font-mono text-xs font-bold text-[#002752] dark:text-sky-300 block hover:underline select-text"
        >
          {row.id}
        </Link>
      ),
        ...
        return (
          <div className="flex items-center gap-3 select-text">
            ...
            <div className="min-w-0">
              <Link
                href={`/admin/users/${encodeURIComponent(row.id)}`}
                className="text-sm font-bold text-slate-900 dark:text-white truncate block hover:underline hover:text-[#002752] dark:hover:text-sky-300"
              >
                {row.name}
              </Link>
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge
            variant="outline"
            className={`text-[11px] font-bold border inline-flex items-center select-text ${
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="space-y-0.5 select-text">
          <div className="text-xs font-bold text-slate-800 dark:text-slate-200 truncate max-w-[200px]">
            {row.role}
          </div>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-center select-text">
          <span className="inline-flex items-center justify-center font-mono font-bold text-xs text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800/80 px-2 py-0.5 rounded-md">
            {row.protocolsCount}
          </span>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Badge
          variant="outline"
          className={`text-[10px] font-semibold border select-text ${
