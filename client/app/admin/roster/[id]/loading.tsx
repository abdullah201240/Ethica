...
export default function ReviewerDossierLoading() {
  return (
    <div className="space-y-6 select-none w-full max-w-full overflow-x-hidden pb-12" aria-busy="true" aria-label="Loading reviewer dossier">
