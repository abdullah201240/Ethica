...
export default function AdminLoginPage() {
  ...
  const handleDemoFill = () => {
    setValue("adminId", "admin.secretariat@diu.edu.bd", { shouldValidate: true })
    setValue("passphrase", "EthicaAdminMaster2026!", { shouldValidate: true })
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  {...register("adminId")}
                  aria-invalid={Boolean(errors.adminId)}
