...
export default function CategoryDossierLoading() {
  return (
    <div className="space-y-6 select-none w-full max-w-full overflow-x-hidden pb-12" aria-busy="true" aria-label="Loading research category dossier">
          ...
          <Card className="p-5 rounded-xl border border-slate-200/85 dark:border-slate-800 bg-white dark:bg-[#0C1E34] shadow-xs space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200/70 dark:border-slate-800 space-y-2">
