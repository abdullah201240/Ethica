...
export default function UserLoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-slate-50/70 via-white to-slate-50/70 dark:from-[#040e1a] dark:via-[#071321] dark:to-[#040e1a] text-slate-900 dark:text-white flex flex-col justify-between overflow-x-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-10 left-1/2 -translate-x-1/2 w-[52rem] sm:w-[72rem] h-[28rem] bg-gradient-to-tr from-[#198754]/12 via-[#002752]/10 to-sky-100/25 blur-3xl rounded-full"
      />
      ...
      <header className="relative z-20 w-full px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 2xl:px-20 py-5 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-tr from-[#002752] via-[#003875] to-[#002752] text-white shadow-md shadow-[#002752]/20 transition-transform group-hover:scale-105">
      ...
      <main className="relative z-10 w-full px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 2xl:px-20 py-8 sm:py-12 flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-lg rounded-2xl sm:rounded-3xl border border-slate-200/85 dark:border-slate-800/80 bg-white/95 dark:bg-card/95 backdrop-blur-xl shadow-2xl p-6 sm:p-10 space-y-6">
          ...
          <div className="p-3 sm:p-3.5 rounded-xl border border-emerald-200/80 dark:border-emerald-800/60 bg-emerald-50/70 dark:bg-emerald-950/40 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="text-xs font-bold px-3 py-1.5 rounded-lg bg-[#198754] hover:bg-[#146c43] text-white shadow-2xs transition-colors shrink-0 cursor-pointer"
            >
              Autofill Demo PI
            </button>
          </div>
          ...
          <div className="space-y-2.5">
            <Button
              ...
              variant="outline"
              onClick={() => {
                setEmail("researcher.pi@diu.edu.bd")
                setPassword("DIU_Institutional_2026")
                setStatusMessage("DIU Academic Single Sign-On selected.")
              }}
              className="w-full h-11 text-xs sm:text-sm font-bold border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center justify-center gap-2 rounded-xl"
            >
              <div className="size-4 rounded-full bg-[#198754] flex items-center justify-center text-[0.6rem] text-white font-black">
                D
              </div>
              <span>Sign in with DIU Academic SSO</span>
            </Button>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <Button
                ...
                variant="outline"
                onClick={() => {
                  setEmail("orcid.0000-0002-1825@orcid.org")
                  setPassword("ORCID_Verified_Token")
                  setStatusMessage("ORCID iD authentication selected.")
                }}
                className="h-10 text-xs font-bold border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center justify-center gap-1.5 rounded-xl"
              >
                <span className="size-3.5 rounded-full bg-[#A6CE39] text-white font-black text-[0.55rem] flex items-center justify-center">
                  iD
                </span>
                <span>ORCID iD</span>
              </Button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 rounded-xl border border-slate-200/85 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-900/60 text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#002752] dark:focus-visible:ring-white transition-all"
                />
              </div>
            </div>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 text-sm sm:text-base font-bold rounded-full bg-gradient-to-r from-[#002752] via-[#003875] to-[#002752] hover:from-[#001c3d] hover:to-[#001c3d] text-white shadow-md hover:shadow-xl hover:shadow-[#002752]/25 gap-2 transition-all duration-300 cursor-pointer"
            >
